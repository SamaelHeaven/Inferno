...
namespace inferno {
    ...
    public:
        ...
        template <typename T> consteval void on_add(constexpr void (*callback)(Entity, T &)) {
            constexpr auto candidate = [callback](entt::entity entity, entt::registry &, auto &component) {
