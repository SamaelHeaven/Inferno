...
namespace inferno {
    ...
    public:
        ...
        template <typename T> consteval void on_add(consteval void (*callback)(Entity, T)) {
            consteval auto candidate = [callback](entt::entity entity, entt::registry &, auto &...components) {
